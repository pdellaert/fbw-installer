    ...
    return (
        <div className={`flex flex-col justify-between gap-y-5 ${textClass} ${darkTheme ? 'bg-navy-dark' : 'bg-quasi-white'} px-6 py-7 h-full`}>
            <div className="flex flex-col -space-y-7">
                <h3 className={`${textClass} font-bold -mb-1 flex items-center`}>
                    {publisherData.verified !== undefined && publisherData.verified === false ? (
                        <span title="This plublisher could not be verified!">
                            <svg viewBox="0 -4 32 32" fill="orange" className="w-16 h-16">
